...
public class EdgeBridge: NSObject, Extension {
    ...
    private func handleTrackRequest(_ event: Event) {
        ...
        dispatchTrackRequest(data: eventData, timestamp: event.timestamp, parentEvent: event)
    }
    ...
    private func handleRuleEngineResponse(_ event: Event) {
        ...
        dispatchTrackRequest(data: consequenceDetail, timestamp: event.timestamp, parentEvent: event)
    }
    ...
    private func dispatchTrackRequest(data: [String: Any], timestamp: Date, parentEvent: Event) {
